...
export HADOOP_CONF_DIR=/opt/edp/hdfs1/conf
...
export HADOOP_LOG_DIR=/opt/edp/hdfs1/log

# Where log files are stored in the secure data environment.
export HADOOP_SECURE_DN_LOG_DIR=${HADOOP_LOG_DIR}

# The directory where pid files are stored. /tmp by default.
export HADOOP_PID_DIR=/opt/edp/hdfs1/data
...
export DATANODE_DATA_DIRS=/opt/edp/hdfs1/data/datanode

# Export dfs.namenode.name.dir
export NAMENODE_DATA_DIRS=/opt/edp/hdfs1/data/namenode
